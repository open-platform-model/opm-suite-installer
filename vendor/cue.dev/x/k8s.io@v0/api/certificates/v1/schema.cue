...
#CertificateSigningRequest: {
	...
	// spec contains the certificate request, and is immutable after creation. Only
	...
	// and the certificate issued by the signer, or the failure condition
