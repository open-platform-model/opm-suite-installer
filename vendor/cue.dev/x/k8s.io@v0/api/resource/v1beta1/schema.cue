...
#BasicDevice: {
	...
	// be set in the per-device status conditions. If any is true, a binding
	// failure occurred.
	//
...
#DeviceRequest: {
	...
	//
	// A class is required if no subrequests are specified in the firstAvailable
	// list and no class can be set if subrequests are specified in the
	...
	// FirstAvailable contains subrequests, of which exactly one will be satisfied
	// by the scheduler to satisfy this request. It tries to satisfy them in the
	// order in which they are listed here. So if there are two entries in the
	// list, the scheduler will only check the second one if it determines that the
