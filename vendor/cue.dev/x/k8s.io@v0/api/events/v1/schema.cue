...
#Event: {
	// action is what action was taken/failed regarding to the regarding object. It
	// is machine-readable. This field cannot be empty for new Events and it can
	...
	// reason is why the action was taken. It is human-readable. This field cannot
	...
	// ReplicaSet object.
	"regarding"?: v1_9.#ObjectReference
	...
	// the future. It is machine-readable. This field cannot be empty for new
	// Events.
	"type"?: string
}
