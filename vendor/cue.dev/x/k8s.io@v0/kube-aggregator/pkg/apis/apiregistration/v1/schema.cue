...
#APIServiceSpec: {
	...
	// GroupPriorityMinimum values such that the whole group gets a higher
	...
	"groupPriorityMinimum"!: int32 & int

	// InsecureSkipTLSVerify disables TLS certificate verification when
	// communicating with this server. This is strongly discouraged. You should use
